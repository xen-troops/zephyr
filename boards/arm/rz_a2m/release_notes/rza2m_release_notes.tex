...
\addcontentsline{toc}{subsection}{6.4. UART support (SCI)}
...
\addcontentsline{toc}{subsection}{6.5. Watchdog support}
...
\addcontentsline{toc}{subsection}{6.6. PWM support}
...
\addcontentsline{toc}{subsection}{6.7. I2C}
...
\addcontentsline{toc}{subsection}{6.8. DMA}
...
\addcontentsline{toc}{subsection}{6.9. RTC}
...
\addcontentsline{toc}{subsection}{6.10. OSTM}
...
\addcontentsline{toc}{subsection}{6.11. BSC}
...
\addcontentsline{toc}{subsection}{6.12. Interrupt controller}
...
\addcontentsline{toc}{subsection}{6.13. SPI Flash Support}
...
\addcontentsline{toc}{subsection}{6.14. MTU PWM Support}
...
\subsection*{6.15. ETHERC Support}\label{eth-support}
\addcontentsline{toc}{subsection}{6.15. ETHERC Support}
...
\begin{lstlisting}
	...
	Interface 0x8009461c (Ethernet) [1]
	===================================
	IPv6 recv      1        sent    13      drop    1       forwarded       0
	IPv6 ND recv   0        sent    7       drop    0
	IPv6 MLD recv  0        sent    6       drop    0
	IPv4 recv      55       sent    54      drop    1       forwarded       0
	IP vhlerr      0        hblener 0       lblener 0
	IP fragerr     0        chkerr  0       protoer 0
	ICMP recv      54       sent    67      drop    1
...
\subsubsection*{6.15.1 ETHERC fixed-link Support}\label{eth-fixed-support}
\addcontentsline{toc}{subsection}{6.15.1 ETHERC fixed-link Support}
